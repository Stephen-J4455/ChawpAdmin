...
export default function DeliveryManagementPage() {
  ...
  const handleViewPerson = async (person) => {
    ...
    const [earningsResult, bankDetailsResult] = await Promise.all([
            ...
            {selectedPerson && (
              <ScrollView style={styles.modalBody}>
                ...
                <View style={styles.detailSection}>
                  ...
                  <Text style={styles.detailValue}>
                    ⭐ Rating: {selectedPerson.rating.toFixed(2)} / 5.00
                  </Text>
                  <Text style={styles.detailValue}>
                    📦 Total Deliveries: {selectedPerson.total_deliveries}
                  </Text>
                  <Text style={styles.detailValue}>
                    ✅ Completed: {selectedPerson.completed_deliveries}
                  </Text>
                  <Text style={styles.detailValue}>
                    ❌ Cancelled: {selectedPerson.cancelled_deliveries}
                  </Text>
                </View>
                          ...
                          {earning.status === "pending" && (
                            <View style={styles.earningActions}>
                              <TouchableOpacity
                                ...
                                onPress={() =>
                                  handleUpdateEarningStatus(earning.id, "paid")
                                }>
